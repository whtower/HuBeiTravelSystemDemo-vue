  ...
  <div id="godDamn">
    <div class="popup">
      ...
      <div v-if="popupInfo.typ==='attractions'" class="moreChoice">
            ...
            <el-button type="text" @click="addFavorite"><span class="el-icon-star-off"></span>{{ buttonactive.FavoriteActive }}</el-button>

            <el-button @click="get_caterings(popupInfo.id)" type="text"><span class="el-icon-food"></span>美食</el-button>

            <el-button @click="get_hotels(popupInfo.id)" type="text"><span class="el-icon-office-building"></span>酒店</el-button>

            <el-button @click="commentButton" type="text"><span class="el-icon-chat-dot-square"></span>评论</el-button>
            </div>
      </div>
